...
ANIMATION_KEYBINDINGS = [
    ("Space", "Воспроизвести / пауза анимации", "Таймлайн"),
    ("←  →", "Предыдущий / следующий кадр", "Таймлайн"),
    ("Home", "Перейти к первому кадру", "Таймлайн"),
    ("End", "Перейти к последнему кадру", "Таймлайн"),
]
